...
RenderScene( )
{
	...
	vkCmdDraw(CommandBuffers[nextImageIndex], vertexCount, instanceCount, firstVertex, firstInstance); vkCmdPushConstants(CommandBuffers[nextImageIndex], GraphicsPipelineLayout,
...
UpdateScene( )
{
	...
	// Might need to move these to Reset, check Push Constant Notes
	...
	*/
	...
	float rot1 = (float)(0.5 * M_PI * Time); // rotation for arm1, in radians

...
//************************P4
	...
	VkDescriptorSetLayoutBinding		AtomsSet[1];
		...
		AtomsSet[0].descriptorType     = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER; //?? what type of buffer does this need to be ??
		AtomsSet[0].descriptorCount    = 1;
		AtomsSet[0].stageFlags		   = VK_SHADER_STAGE_VERTEX_BIT | VK_SHADER_STAGE_FRAGMENT_BIT; //?? what type of buffer does this need to be ??
...
//************************P4
	VkDescriptorSetLayoutCreateInfo			vdslc4;
		vdslc4.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO; //?? what type of structure is this ??
